package cn.edu.lingnan.mooc.authorize.service.impl;

import cn.edu.lingnan.mooc.authorize.util.RedisKeyUtil;
import cn.edu.lingnan.mooc.authorize.dao.ManagerDAO;
import cn.edu.lingnan.mooc.authorize.dao.RoleDAO;
import cn.edu.lingnan.mooc.authorize.dao.UserDAO;
import cn.edu.lingnan.mooc.authorize.model.entity.MenuTree;
import cn.edu.lingnan.mooc.authorize.model.entity.MoocManager;
import cn.edu.lingnan.mooc.authorize.model.entity.MoocUser;
import cn.edu.lingnan.mooc.authorize.model.entity.OnlineUser;
import cn.edu.lingnan.mooc.authorize.model.enums.AuthorizeExceptionEnum;
...
import cn.edu.lingnan.mooc.authorize.model.vo.UserMenuTreeVO;
import cn.edu.lingnan.mooc.authorize.service.AuthorizeService;
import cn.edu.lingnan.mooc.authorize.service.MenuTreeService;
import cn.edu.lingnan.mooc.common.exception.MoocException;
import cn.edu.lingnan.mooc.common.enums.ExceptionEnum;
import cn.edu.lingnan.mooc.authorize.dao.MenuTreeDAO;
...
public class AuthorizeServiceImpl implements AuthorizeService {
    ...
    public LoginSuccessVO login(LoginParam loginParam){
        ...
        LoginSuccessVO loginSuccessVO = setRedisAndBuildLoginSuccessVO(manager);
    ...
    private LoginSuccessVO setRedisAndBuildLoginSuccessVO(MoocManager manager) {
        ...
        return new LoginSuccessVO(tokenKey, manager.getType() , manager.getId(), menuVOList);
    }
