package cn.edu.lingnan.mooc.authorize.shiro.service;

import cn.edu.lingnan.mooc.authorize.shiro.constant.UserConstant;
import cn.edu.lingnan.mooc.authorize.shiro.dao.ManagerDAO;
import cn.edu.lingnan.mooc.authorize.shiro.dao.MenuTreeDAO;
import cn.edu.lingnan.mooc.authorize.shiro.dao.RoleDAO;
import cn.edu.lingnan.authorize.shiro.entity.*;
import cn.edu.lingnan.mooc.authorize.shiro.util.HttpServletUtil;
import cn.edu.lingnan.mooc.authorize.shiro.util.RedisUtil;
import cn.edu.lingnan.mooc.authorize.shiro.util.RsaUtil;
import cn.edu.lingnan.mooc.authorize.shiro.entity.*;
...
public class AuthorizeService {
    ...
    public RespResult login(@Valid LoginParam loginParam, HttpServletRequest request){
