package cn.edu.lingnan.mooc.statistics.dao.mapper;
...
public interface CourseMapper {
      ...
      * @return
      */
     List<Map<String,Object>> countCourseCategoryByUserId(Long userId);
      ...
      * @return
      */
     List<Map<String,Object>> countCommentGroupByTime(@Param("teacherId")Long teacherId,@Param("beginTime") Date beginTime,@Param("endTime") Date endTime);
