...
public class ExcelImportTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ExcelImportTest.class);
    ...
    public void simpleRead() {
        ...
        // 写法1：
        String fileName = "D:\\data" + File.separator + "test.xlsx";
        //这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
        EasyExcel.read(fileName, IpBlacklistImport.class, new IpBlacklistListener(ipBlacklistRepository)).sheet().doRead();
...
/*    *//**
    ...
    *//**
     ...
     * <p>
     * 1. 创建excel对应的实体对象 参照{@link IpBlacklistImport}
     * <p>
     * 2. 由于默认一行行的读取excel，所以需要创建excel一行一行的回调监听器，参照{@link IpBlacklistListener}
     * <p>
     * 3. 直接读即可
     *//*
    @Test
