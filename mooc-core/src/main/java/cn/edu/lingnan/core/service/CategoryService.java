...
public class CategoryService {
     ...
     * @return
     */
    public PageVO<Category> findPage(Category matchObject, Integer pageIndex, Integer pageSize){
        // 1、构造条件
        ...
        pageVO.setContent(categoryList);
     ...
     * @return 返回成功数
     */
    public Integer insertOrUpdate(Category category){
        if (category == null) {
            throw new IllegalArgumentException("插入表的对象不能为null");
        }
        // id不为空，表示更新操作
